public class CafeJava{
    public static void main(String[]args){
        ...
        if(isReadyOrder2){
            double price = lattePrice*2;
            System.out.println(customer2 + readyMessage + displayTotalMessage + price);
        }
        ...
        System.out.println("Error  "+customer3+ displayTotalMessage+lattePrice+"not $"+coffeePrice);
    }
}